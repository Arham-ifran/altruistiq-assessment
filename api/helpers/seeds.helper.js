...
import { DELAY_IN_REQUESTS } from './../configs/vars';
...
/**
 * Fetch data for a country with rate limiting.
 * 
 ...
 */
export const fetchDataWithRateLimiting = async (countryCode) => {
  // Add delay between requests to handle rate limiting
  await new Promise(resolve => setTimeout(resolve, DELAY_IN_REQUESTS));
